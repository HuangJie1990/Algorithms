...
[WARN] Percolation.java:102:31: The local (or parameter) variable 'row' has the same name as an instance variable. Use a different name. [HiddenField]
...
student PercolationStats mean() = 0.200000
